...
**Note:** This guide describes manual deployment for development. For production deployment, use the automated installer included in the release tarball. See [README.md](../README.md) for current configuration format (v1.2.0+ uses `sensors` array, v1.4.0+ adds `humidity_enabled` field).
